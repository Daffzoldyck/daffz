        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/miayam.jpg" className="w-10 rounded-md" />
              <q>aku nak mi ayam</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Dafa Ahzatia" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="An expert in AI technology ( AI Engineer ) and web developer dedicated to crafting modern, high-performance digital experiences through innovative and user-friendly solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="Hi! I am Dafa Ahzatia, a vocational high school student specializing in Computer and Network Engineering with a deep passion for technology, programming, and digital innovation. I enjoy building functional and simple web-based projects while continuously exploring networking systems and modern development tools. For me, technology is not just a subject of study but a field of creativity and problem-solving. I am committed to growing as a developer, sharpening my technical skills, and preparing myself to contribute to the digital world through impactful and useful solutions."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      12<span className="text-violet-500">+</span>
                    </h1>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.dazht156@gmail.com"
                method="POST"
